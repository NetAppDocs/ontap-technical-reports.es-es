...
Para más información sobre cómo los volúmenes de FlexGroup se benefician de la arquitectura AFX, consulta link:afx-overview-architecture.html#flexgroup-volume-management-improvements["FlexGroup mejoras en la gestión de volúmenes"].
