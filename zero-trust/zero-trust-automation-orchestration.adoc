...
Ansible es una herramienta de código abierto para el aprovisionamiento, la gestión de la configuración y la puesta en marcha de aplicaciones. Funciona en numerosos sistemas de tipo Unix y permite configurar tanto sistemas de tipo Unix como Microsoft Windows. Incluye su propio lenguaje declarativo para describir la configuración del sistema. Ansible fue creado por Michael DeHaan y adquirido por Red Hat en 2015. Ansible no utiliza agentes, sino que se conecta de forma temporal y remota a través de SSH o de la Administración remota de Windows (lo que permite la ejecución remota de PowerShell) para realizar tareas. NetApp ha desarrollado más de https://www.netapp.com/devops/ansible/["150 Módulos Ansible para software ONTAP"^], lo que permite una mayor integración con el marco de automatización de Ansible. Los módulos de Ansible para NetApp proporcionan un conjunto de instrucciones sobre cómo definir el estado deseado y transmitirlo al entorno de destino NetApp. Los módulos están diseñados para realizar tareas como la configuración de licencias, la creación de agregados y máquinas virtuales de almacenamiento, la creación de volúmenes y la restauración de instantáneas, por nombrar algunas. Se ha creado una función de Ansible https://github.com/NetApp/ansible/tree/master/nar_ontap_security_ucd_guide["Publicado en GitHub"^] específica para la guía de puesta en marcha de Capacidades Unificadas (UC) del Departamento de Defensa (DoD) NetApp.
