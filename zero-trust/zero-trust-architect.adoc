...
En la terminología del modelo Zero Trust, la clasificación de datos implica la identificación de datos tóxicos.  Los datos tóxicos son datos confidenciales que no deben exponerse fuera de una organización.  La divulgación de datos tóxicos podría violar el cumplimiento normativo y dañar la reputación de una organización.  En términos de cumplimiento normativo, los datos tóxicos incluyen datos del titular de la tarjeta para https://www.netapp.com/us/media/tr-4401.pdf["Estándar de seguridad de datos del sector de tarjetas de pago (PCI-DSS)"^] , datos personales para la UE https://www.netapp.com/us/info/gdpr.aspx["Reglamento general sobre la protección de datos (GDPR)"^] , o datos de atención sanitaria para el https://www.hhs.gov/hipaa/for-professionals/privacy/laws-regulations/index.html["Ley de Portabilidad y Responsabilidad de Seguros Médicos (HIPAA)"^] .  Puedes utilizar NetApp https://www.netapp.com/data-services/classification/["NetApp Data Classification"^] (anteriormente conocido como Cloud Data Sense), un conjunto de herramientas impulsado por IA, para escanear, analizar y categorizar automáticamente sus datos.
