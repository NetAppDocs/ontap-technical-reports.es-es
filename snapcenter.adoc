...
link:https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-sc-generic-scope.html["TR-4614: Backup y recuperación de datos de SAP HANA con SnapCenter"^] SnapCenter es una plataforma unificada y escalable para la protección de datos consistente con las aplicaciones, destinada a SAP HANA y otras bases de datos. SnapCenter ofrece control y supervisión centralizados, mientras delega en los usuarios la capacidad de gestionar tareas de copia de seguridad, restauración y clonación específicas de cada aplicación. Con SnapCenter, los administradores de bases de datos y almacenamiento aprenden a usar una sola herramienta para gestionar las operaciones de copia de seguridad, restauración y clonación de una variedad de aplicaciones y bases de datos.
