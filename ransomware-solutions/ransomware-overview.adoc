...
NOTE: NetApp ONTAP satisface el requisito de autenticación basada en web https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf["Autenticación multifactor (MFA)"^] en System Manager y para la autenticación CLI de SSH.
...
* link:ransomware-DII-workload-security.html["Data Infrastructure Insights Almacenamiento Carga de trabajo Seguridad"]
