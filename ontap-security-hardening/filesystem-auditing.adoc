...
NOTE: La API de REST /api/storage/volumes se utiliza para algo más que el acceso a archivos. Es utilizada por System Manager y otras interfaces GUI para crear, ver y modificar volúmenes.
