...
Para obtener más información sobre MFA para ONTAP System Manager, Active IQ Unified Manager y SSH, consulta link:https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf["TR-4647: Autenticación multifactor en ONTAP 9"^].
