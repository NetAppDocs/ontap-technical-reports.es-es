...
NOTE: No puedes eliminar ni renombrar cuentas integradas. Si un administrador elimina la cuenta, al reiniciar, la cuenta integrada se volverá a crear. *NetApp recomienda* bloquear cualquier cuenta integrada que no necesites con el comando lock.
