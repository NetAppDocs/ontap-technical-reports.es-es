...
.IP de MetroCluster
link:https://www.netapp.com/pdf.html?item=/media/13481-tr4689.pdf["TR-4689: Dirección IP de NetApp MetroCluster"^] MetroCluster es una solución de almacenamiento de disponibilidad continua para ONTAP que se ejecuta en sistemas FAS y AFF. MetroCluster IP es la última evolución que utiliza un entramado de almacenamiento back-end basado en Ethernet. MetroCluster IP ofrece una configuración altamente redundante para satisfacer las necesidades de las aplicaciones empresariales fundamentales. MetroCluster IP se incluye en ONTAP y proporciona conectividad NAS y SAN para clientes y servidores que utilizan el almacenamiento ONTAP.
