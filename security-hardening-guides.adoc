...
link:https://www.netapp.com/pdf.html?item=/media/83591-tr-4963.pdf["TR-4963: Guía de refuerzo de la seguridad: NetApp Backup and Recovery para aplicaciones"^]Aprenda a configurar NetApp Cloud Backup for Applications para ayudar a las organizaciones a cumplir los objetivos de seguridad prescritos para la confidencialidad, integridad y disponibilidad del sistema de información.
